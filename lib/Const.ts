...
const GraphApiEndpoint = {
	...
	RemoveChatMember: (threadId: string, membershipId: string) => `chats/${threadId}/members/${membershipId}`,
	Message: (threadId: string) => `chats/${threadId}/messages`,
	DeleteMessage: (userId: string, threadId: string, messageId: string) => `users/${userId}/chats/${threadId}/messages/${messageId}/softDelete`,
...
export const ProvisionTeamsBotUserFailedMessageText: string = 'Provision Teams bot user FAILED! Please check trouble shooting guide for further actions.';
export const DeleteTeamsBotUserSucceedMessageText: string = 'Delete Teams bot user succeed!';
export const DeleteTeamsBotUserFailedMessageText: string = 'Delete Teams bot user FAILED! Please check trouble shooting guide for further actions.';
...
export const LoginNoNeedHintMessageText: string =
	'You have already login Microsoft Teams to start cross platform collaboration for your account. ' + 'No need to login again.';
...
export const UnsupportedScenarioHintMessageText = (scenario: string) =>
	`${scenario} is not supported by TeamsBridge app for cross platform collaboration.` + " This message won't be delivered to target user on Teams.";
...
export const LoginAppUserAlreadyLoggedInMessageText: string = 'The app user has already logged in to Microsoft Teams. No need to login again.';
...
export const AppUserAddedToRoomMessageText: string =
...
export const RoomNotBridgedHintMessageText: string = 'This room is not bridged to Microsoft Teams. To activate bridging, add me to this room.';
...
export const BridgeStatusInactiveMessageText: string = '❌ This room is **not bridged** to Microsoft Teams. To activate bridging, add me to this room.';
...
export const SupportedNotificationChangeTypes = ['created', 'updated', 'deleted'];
...
export const getGraphApiMessageDeleteUrl = (userId: string, threadId: string, messageId: string) => {
